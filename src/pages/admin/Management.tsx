  ...
  return (
    <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        <div>
          <h1 className="text-4xl font-black text-slate-900 tracking-tighter">Strategize <span className="text-blue-600">Management</span></h1>
        ...
        <section className="bg-white p-10 rounded-[40px] border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.02)]">
          <div className="flex justify-between items-center mb-10">
            ...
            <button 
              ...
              className="bg-blue-600 text-white px-6 py-3 rounded-2xl font-black hover:bg-blue-700 transition-all flex items-center gap-2 shadow-lg shadow-blue-100"
            >
          ...
          <div className="space-y-4">
            {competencyFrameworks.map(cf => (
              <div key={cf.id} className="p-6 bg-slate-50 border border-slate-100 rounded-3xl group transition-all hover:bg-white hover:border-blue-100 hover:shadow-xl hover:shadow-blue-50/50">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    <h4 className="font-black text-slate-900 text-lg group-hover:text-blue-600 transition-colors">{cf.name}</h4>
                ...
                <div className="flex gap-2">
                   <button className="text-xs font-black uppercase tracking-widest text-slate-400 hover:text-blue-600 transition-colors">Edit Framework</button>
      ...
      {isFrameworkModalOpen && (
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-md z-[100] flex items-center justify-center p-6">
          <div className="bg-white w-full max-w-2xl rounded-[40px] p-12 shadow-2xl space-y-10 animate-in zoom-in-95 duration-300">
            <div>
              <h2 className="text-3xl font-black text-slate-900 tracking-tight">Define Competency <span className="text-blue-600">Framework</span></h2>
            ...
            <div className="space-y-6">
               <div className="space-y-2">
                 ...
                 <input 
                   ...
                   className="w-full bg-slate-50 border border-slate-100 rounded-2xl px-6 py-4 font-black text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all" 
               ...
               <div className="space-y-4">
                 <div className="flex justify-between items-center">
                   ...
                   <button 
                     onClick={addQuestion}
                     className="text-blue-600 font-black text-xs hover:text-blue-700 transition-colors uppercase tracking-widest flex items-center gap-2"
                   >
...
const ProtocolCard = ({ type, description }: any) => (
  <div className="flex items-center justify-between p-8 bg-slate-50 border border-slate-100 rounded-[32px] group transition-all hover:bg-white hover:border-blue-100 hover:shadow-lg hover:shadow-blue-50/50">
    ...
    <div className="flex flex-col items-end gap-3">
      ...
      <button className="text-xs font-black text-blue-600 uppercase tracking-widest hover:underline underline-offset-4">Configure</button>
    </div>
  </div>
);
