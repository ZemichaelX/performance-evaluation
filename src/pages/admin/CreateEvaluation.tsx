    ...
    <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
      ...
      <div className="relative">
        ...
        <header className="relative flex flex-col md:flex-row justify-between items-start md:items-end gap-6 p-8 bg-white/40 backdrop-blur-xl rounded-[48px] border border-white/60 shadow-[0_20px_70px_rgba(0,0,0,0.08)]">
          ...
          {/* Premium Stepper */}
          <div className="relative">
            <div className="absolute -inset-2 bg-gradient-to-r from-blue-100 via-purple-100 to-pink-100 rounded-[32px] opacity-40 blur-xl" />
                ...
                <div key={s} className="flex items-center gap-3">
                  <div 
                    className={`w-10 h-10 rounded-xl flex items-center justify-center text-xs font-black transition-all duration-500 ${
                      step === s 
                        ? 'bg-gradient-to-br from-blue-600 to-purple-600 text-white shadow-lg shadow-blue-200 scale-110' 
                        : step > s 
      ...
      <div className="relative">
        <div className="absolute -inset-4 bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100 rounded-[56px] opacity-20 blur-2xl" />
        <div className="relative bg-white/80 backdrop-blur-xl border border-white/60 rounded-[48px] p-12 shadow-[0_20px_70px_rgba(0,0,0,0.08)] min-h-[600px] flex flex-col">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="relative group w-80">
                    ...
                    <input 
                      ...
                      className="w-full bg-white/90 backdrop-blur-sm border-2 border-slate-200/50 rounded-2xl pl-12 pr-4 py-3.5 text-sm focus:outline-none focus:border-blue-300 focus:ring-4 focus:ring-blue-50 transition-all font-bold shadow-sm"
                    />
                  </div>
                </div>
                      ...
                      >
                        <div className="flex items-center gap-4">
                          ...
                          <div className="text-left">
                            ...
                            <p className="text-[10px] font-black uppercase tracking-widest text-blue-500 animate-pulse">Configure Evaluators</p>
                          </div>
                        </div>
                              ...
                              <section className="space-y-4 text-left">
                                ...
                                <div className="relative">
                                  ...
                                  <input
                                    ...
                                    className="w-full bg-white border border-slate-200 rounded-xl pl-10 pr-4 py-2 text-xs focus:outline-none focus:border-blue-300 focus:ring-2 focus:ring-blue-50 transition-all"
                                  />
                                </div>
                                      ...
                                      return (
                                        <button 
                                          ...
                                          className={`flex items-center gap-3 p-3 rounded-xl border text-left transition-all ${
                                            selected ? 'bg-blue-600 border-blue-600 text-white shadow-md' : 'bg-white border-slate-100 hover:border-blue-200'
                                          }`}
                                        >
          ...
          {step === 4 && (
            <div className="space-y-10 animate-in fade-in slide-in-from-right-4 duration-500 text-left">
              <div className="flex justify-between items-center">
                <h2 className="text-3xl font-black bg-gradient-to-r from-slate-900 to-blue-900 bg-clip-text text-transparent flex items-center gap-4">
                  <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-purple-500 to-blue-600 flex items-center justify-center shadow-lg shadow-purple-200">
              ...
              <div className="max-w-3xl mx-auto space-y-10">
                ...
                <section className="bg-blue-600 p-8 rounded-[40px] shadow-2xl shadow-blue-100 text-white space-y-6">
                  <div className="flex justify-between items-center sm:flex-row flex-col gap-4">
                  <div>
                    <h3 className="font-black text-2xl tracking-tight">Framework Library</h3>
                    <p className="text-blue-200 text-sm font-semibold mt-1">Industrial Competency Suites</p>
                  </div>
                    <div className="relative w-full sm:w-auto">
                      ...
                      <input 
                        ...
                        className="bg-blue-700/50 border-none rounded-2xl pl-11 pr-4 py-3 text-sm font-semibold placeholder:text-blue-400 focus:ring-2 focus:ring-blue-400 outline-none w-full sm:w-56 transition-all focus:sm:w-72 text-white"
                      />
                    </div>
                  </div>
                      ...
                      return (
                        <button 
                          ...
                          className={`p-4 rounded-[28px] border text-left transition-all group relative overflow-hidden ${
                            isAdded 
                              ? 'bg-white text-blue-600 border-white shadow-lg translate-y-[-2px]' 
                              : 'bg-blue-700/40 border-blue-500/30 text-blue-100 hover:bg-blue-700/60'
                          }`}
                        >
                          <div className="flex justify-between items-start mb-2 relative z-10">
                             <div className={`w-8 h-8 rounded-xl flex items-center justify-center transition-all ${isAdded ? 'bg-blue-100 text-blue-600' : 'bg-blue-800 text-blue-400 group-hover:bg-blue-700'}`}>
                               {isAdded ? <Check className="w-4 h-4" /> : <Plus className="w-4 h-4" />}
                             </div>
                          </div>
                          <p className="font-black text-sm leading-tight transition-colors relative z-10">{f.name}</p>
                          <p className={`text-xs font-semibold mt-1.5 relative z-10 ${isAdded ? 'text-blue-400' : 'text-blue-300/70'}`}>{f.questions.length} Metrics</p>
                        </button>
                      );
                    })}
                  </div>
                ...
                <section className="bg-slate-50 p-10 rounded-[40px] border border-slate-100 space-y-8">
                   <h3 className="font-black text-slate-900 flex justify-between items-center">
                     ...
                     <button 
                       ...
                       className="text-blue-600 text-sm font-bold flex items-center gap-2 px-5 py-2.5 bg-white rounded-xl shadow-sm border border-slate-100 transition-all hover:shadow-md active:scale-95"
                     >
                   ...
                   <div className="space-y-4">
                      {formData.questionCollections.map((qc, idx) => {
                        ...
                        return (
                          <div key={qc.id} className={`bg-white rounded-[32px] border transition-all overflow-hidden ${isExpanded ? 'border-blue-200 ring-4 ring-blue-50/50 shadow-xl' : 'border-slate-100 hover:border-slate-200 shadow-sm'}`}>
                             <div className="p-6">
                               <div className="flex gap-4 items-start">
                                 <div className="flex-1 space-y-3">
                                    <div className="flex items-center gap-3">
                                      ...
                                      />
                                      {framework && (
                                        <span className="text-xs font-bold text-blue-500 bg-blue-50 px-3 py-1 rounded-lg shrink-0">Industrial Suite</span>
                                      )}
                                    </div>
                                    <select 
                               ...
                               <div className="pt-4 mt-2 border-t border-slate-50">
                                 ...
                                 >
                                   <div className="flex items-center gap-3">
                                     ...
                                     <span className="text-xs font-bold text-blue-600 bg-blue-50 px-3 py-1.5 rounded-full border border-blue-100/50">
                                       { (framework?.questions.length || 0) + qc.customQuestions.length } Questions
                                     </span>
                                   </div>
                                   <ChevronDown className={`w-5 h-5 text-slate-300 group-hover/btn:text-blue-500 transition-all duration-500 ${isExpanded ? 'rotate-180 text-blue-500' : ''}`} />
                                 </button>
                                       ...
                                       <div className="pt-6 space-y-4">
                                          ...
                                          <div className="grid gap-2">
                                            {framework?.questions.map((q, qIdx) => {
                                              ...
                                              return (
                                                <div key={q.id} className={`p-4 rounded-2xl text-[11px] font-bold flex gap-4 border transition-all group/item ${isModified ? 'bg-amber-50/30 border-amber-100 hover:border-amber-200' : 'bg-slate-50/50 border-slate-100 hover:bg-white hover:border-blue-100 hover:shadow-sm'}`}>
                                                  <span className={`font-serif italic text-xs transition-colors ${isModified ? 'text-amber-500' : 'text-blue-300'}`}>#{qIdx + 1}</span>
                                          ...
                                          <div className="relative py-4">
                                            ...
                                            <div className="relative flex justify-center">
                                              <button 
                                                ...
                                                className="bg-white px-4 text-blue-600 text-[9px] font-black uppercase tracking-[0.2em] border border-slate-100 rounded-full py-1.5 shadow-sm hover:shadow-md transition-all active:scale-95"
                                              >
                                                + Add Custom Question
                                              </button>
                                            </div>
          ...
          {step === 5 && (
            <div className="space-y-10 text-center py-10 animate-in zoom-in-95 duration-500">
               <div className="w-32 h-32 bg-blue-600 rounded-[48px] flex items-center justify-center mx-auto text-white shadow-2xl shadow-blue-200 mb-10 transform rotate-12 scale-110">
                  <Check className="w-16 h-16" />
               </div>
               <div>
                  <h2 className="text-4xl font-black text-slate-900 tracking-tight">System Ready <span className="text-blue-600">for Release</span></h2>
               ...
               <div className="max-w-2xl mx-auto grid md:grid-cols-2 gap-4 text-left">
                  <div className="p-6 bg-slate-50 rounded-3xl border border-slate-100">
                     ...
                     <div className="space-y-3">
                        <p className="text-sm font-black flex justify-between"><span>Audit Scope</span> <span className="text-blue-600">{formData.evaluateeIds.length} Entities</span></p>
                        <p className="text-sm font-black flex justify-between"><span>Metric Types</span> <span className="text-blue-600">{formData.questionCollections.length} Collections</span></p>
                  ...
                  <div className="p-6 bg-blue-600 rounded-3xl shadow-xl shadow-blue-100 flex flex-col justify-center text-white">
        ...
        <div className="mt-16 pt-12 border-t border-slate-50 flex justify-between items-center gap-6">
          ...
          <div className="flex gap-4">
             ...
             <button 
               ...
               className="px-12 py-5 bg-blue-600 text-white font-black rounded-[24px] shadow-2xl shadow-blue-100 hover:bg-blue-700 transition-all flex items-center gap-4 transform active:scale-95 group"
             >
                {step === 5 ? (
